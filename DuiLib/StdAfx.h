...
#define WM_USER_SETTINGWINDOWSCROLL                 WM_USER + 0x1030
#define WM_USER_RETRIEVALWINDOWSCROLL               WM_USER + 0x1045	//处理选题检索框滚动消息
//{{AFX_INSERT_LOCATION}}
// Microsoft Visual C++ will insert additional declarations immediately before the previous line.

#endif // !defined(AFX_STDAFX_H__E30B2003_188B_4EB4_AB99_3F3734D6CE6C__INCLUDED_)

#define GetLogFun(level) \
	(CSPLogger::getLogger(WSP_LOG_DUILIB)->write##level)