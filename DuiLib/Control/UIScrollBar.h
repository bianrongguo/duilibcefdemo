...
namespace DuiLib
{
	...
	public:
		...
		//add by liulong 2015-06-15 
		void SetButton1Height(int iHeight);
		void SetButton2Height(int iHeight);
		int GetButton1Height();
		int GetButton2Height();
		//end add
	...
	protected:
		...
		int m_nScrollPos;
		int m_nLineSize;
		int m_iButton1Height;
		int m_iButton2Height;
