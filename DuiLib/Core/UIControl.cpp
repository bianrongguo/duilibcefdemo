...
void CControlUI::SetPos(RECT rc)
{
	...
	RECT rc_old = m_rcItem; // [zhang][2013/8/20]: for size change notification
    m_rcItem = rc;
	...
	// [zhang][2013/8/20]: for size change notification
	/*if (rc_old.left != rc.left || rc_old.top != rc.top || rc_old.right != rc.right || rc_old.bottom != rc.bottom)
	{
...
void CControlUI::DoEvent(TEventUI& event)
{
	...
	// zhangcl 2014-04-20 处理右键弹起消息
	if (event.Type == UIEVENT_RBUTTONUP)
	{
		m_pManager->SendNotify(this, DUI_MSGTYPE_RBUTTONUP, event.wParam, event.lParam);
		return;
	}

	// zhangcl 2015-08-25 处理回车消息
...
void CControlUI::SetUserData1(LPCTSTR pstrText)
{
	m_strUserData1 = pstrText;
}

void CControlUI::SetUserData2(LPCTSTR pstrText)
{
	m_strUserData2 = pstrText;
}

void CControlUI::SetUserData3(LPCTSTR pstrText)
{
	m_strUserData3 = pstrText;
}

void CControlUI::SetUserData4(LPCTSTR pstrText)
{
	m_strUserData4 = pstrText;
}

void CControlUI::SetUserData5(LPCTSTR pstrText)
{
	m_strUserData5 = pstrText;
}

void CControlUI::SetUserData6(LPCTSTR pstrText)
{
	m_strUserData6 = pstrText;
}

void CControlUI::SetUserData7(LPCTSTR pstrText)
{
	m_strUserData7 = pstrText;
}

void CControlUI::SetUserData8(LPCTSTR pstrText)
{
	m_strUserData8 = pstrText;
}

void CControlUI::SetUserData9(LPCTSTR pstrText)
{
	m_strUserData9 = pstrText;
}

void CControlUI::SetUserData10(LPCTSTR pstrText)
{
	m_strUserData10 = pstrText;
}

const CDuiString& CControlUI::GetUserData1()
{
	return m_strUserData1;
}

const CDuiString& CControlUI::GetUserData2()
{
	return m_strUserData2;
}

const CDuiString& CControlUI::GetUserData3()
{
	return m_strUserData3;
}

const CDuiString& CControlUI::GetUserData4()
{
	return m_strUserData4;
}

const CDuiString& CControlUI::GetUserData5()
{
	return m_strUserData5;
}

const CDuiString& CControlUI::GetUserData6()
{
	return m_strUserData6;
}

const CDuiString& CControlUI::GetUserData7()
{
	return m_strUserData7;
}

const CDuiString& CControlUI::GetUserData8()
{
	return m_strUserData8;
}

const CDuiString& CControlUI::GetUserData9()
{
	return m_strUserData9;
}

const CDuiString& CControlUI::GetUserData10()
{
	return m_strUserData10;
}
