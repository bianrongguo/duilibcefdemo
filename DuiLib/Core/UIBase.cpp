...
UINT CWindowWnd::ShowModal()
{
    ...
    while( ::IsWindow(m_hWnd) && ::GetMessage(&msg, NULL, 0, 0) ) {
		...
		if (msg.message == WM_KEYDOWN)
		{
			...
			{
				SendMessage(msg.message, msg.wParam, (LPARAM)&msg);
				continue;
			}
		}
...
void CWindowWnd::CenterWindow()
{
	...
	//Chg By Lch 2014-3-21
	//default hide the CenterWindow 
	//::SetWindowPos(m_hWnd, NULL, xLeft, yTop, -1, -1, SWP_NOSIZE | SWP_NOZORDER | SWP_NOACTIVATE);
	::SetWindowPos(m_hWnd, HWND_TOPMOST, xLeft, yTop, -1, -1, SWP_NOSIZE | SWP_NOZORDER | SWP_NOACTIVATE | SWP_HIDEWINDOW);
}
