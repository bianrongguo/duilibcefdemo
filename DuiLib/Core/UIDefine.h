...
// zhangcl 2015-04-20 右键弹起消息
#define DUI_MSGTYPE_RBUTTONUP              (_T("rbuttonup"))
// zhangcl 2015-04-27 双击消息处理
#define DUI_MSGTYPE_DBCLICK                (_T("dbclick"))
// zhangcl 2015-07-27 对于向上方向键消息处理
#define DUI_MSGTYPE_UP                     (_T("directionup"))
// zhangcl 2015-07-27 对于向下方向键消息处理
#define DUI_MSGTYPE_DOWM                   (_T("directiondown"))
// zhangcl 2015-07-27 对于向左方向键消息处理
#define DUI_MSGTYPE_LEFT                   (_T("directionleft"))
// zhangcl 2015-07-27 对于向右方向键消息处理
#define DUI_MSGTYPE_RIGHT                  (_T("directionright"))
